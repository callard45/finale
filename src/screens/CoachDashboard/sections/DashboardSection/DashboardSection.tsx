      ...
      <div className="flex flex-col items-center justify-center h-full p-8 bg-gradient-to-br from-slate-50 to-white">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-600 max-w-md">No student found with ID: {studentId}</p>
          </div>
          <Button 
            onClick={onBack}
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-600 text-base font-medium">
              Detailed view of {student.name.split(' ')[0]}'s academic and professional information
            </p>
          </div>
        </div>
              ...
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
                  ...
                  if (student) {
                    ...
                    alert(`No student found matching "${searchInput.trim()}"`);
                  }
                }
              }}
