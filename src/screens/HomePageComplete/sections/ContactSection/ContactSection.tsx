...
export const ContactSection = (): JSX.Element => {
  ...
  const faqItems = [
    {
      question: "What is GenKreer and how does it work?",
      answer:
        "GenKreer is an AI-powered career assistant that helps students create professional CVs, prepare for interviews, and track job applications. It works by conducting an AI interview to understand your background and goals, then generates tailored career documents and provides ongoing feedback.",
    },
    {
      question: "Is GenKreer free for students?",
      answer:
        "GenKreer offers a free basic plan for all students. Many universities also partner with us to provide premium features to their students at no cost. Check if your school is a partner or contact your career services office.",
    },
    {
      question: "How do I get started with GenKreer?",
      answer:
    ...
    {
      question: "How can schools or universities partner with GenKreer?",
      answer:
      ...
      <div className="container mx-auto py-10">
        ...
        <footer className="bg-slate-800 text-white py-[60px] px-[120px] rounded-none w-full">
          ...
          <div className="pt-5 flex items-center justify-between border-b border-[#ffffff20]">
            <p className="text-sm text-slate-400 font-['Inter',Helvetica]">
              © 2023 GenKreer. All rights reserved.
            </p>
            <div className="flex items-center gap-4">
              {socialMedia.map((item, index) => (
                <a
