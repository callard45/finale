...
import { networkProfiles, NetworkProfile } from "../../data/networkProfiles";
        ...
        <section className="flex flex-col gap-8 max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-800 tracking-tight">Network</h1>
            ...
            <form onSubmit={handleSearch} className="flex gap-6">
              <div className="relative flex-1">
                ...
                <Input 
                  ...
                  placeholder="Search by name, skills, role, university..."
                  value={searchQuery}
            ...
            {currentProfiles.map((profile) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-5 w-full">
                  ...
                  {/* Skills section - static display */}
                  <div className="flex flex-wrap gap-2 justify-center">
                    {profile.skills.slice(0, 3).map((skill, index) => (
                      <span 
                        key={index} 
                        className="px-3 py-1 text-xs rounded-full font-medium border bg-gradient-to-r from-slate-50 to-slate-100 text-slate-700 border-slate-200/60 group-hover:from-blue-50 group-hover:to-blue-100 group-hover:text-blue-700 group-hover:border-blue-200/60 transition-all duration-200"
                      >
                        {skill}
                      </span>
                    ))}
                    {profile.skills.length > 3 && (
                      <span className="px-3 py-1 text-xs rounded-full font-medium border bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 border-blue-200/60">
